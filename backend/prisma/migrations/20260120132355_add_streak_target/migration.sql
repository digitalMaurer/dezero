...
INSERT INTO "new_test_attempts" ("cantidadCorrectas", "cantidadIncorrectas", "createdAt", "id", "mode", "oposicionId", "puntaje", "streakCurrent", "streakMax", "testId", "tiempoFin", "tiempoInicio", "updatedAt", "userId") SELECT "cantidadCorrectas", "cantidadIncorrectas", "createdAt", "id", "mode", "oposicionId", "puntaje", "streakCurrent", "streakMax", "testId", "tiempoFin", "tiempoInicio", "updatedAt", "userId" FROM "test_attempts";
