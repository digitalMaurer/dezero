...
CREATE TABLE "new_test_attempts" (
    ...
    "streakTarget" INTEGER NOT NULL DEFAULT 30,
    "queue" TEXT DEFAULT '[]',
    "queueCursor" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_test_attempts" ("cantidadCorrectas", "cantidadIncorrectas", "createdAt", "id", "mode", "oposicionId", "puntaje", "streakCurrent", "streakMax", "streakTarget", "testId", "tiempoFin", "tiempoInicio", "updatedAt", "userId") SELECT "cantidadCorrectas", "cantidadIncorrectas", "createdAt", "id", "mode", "oposicionId", "puntaje", "streakCurrent", "streakMax", "streakTarget", "testId", "tiempoFin", "tiempoInicio", "updatedAt", "userId" FROM "test_attempts";
